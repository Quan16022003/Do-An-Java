...
//        home = (HomeFrm) parent;
    ...
    private void initComponents() {
       ...
       // setTitle("THÔNG TIN GIÁO VIÊN");
        ...
        txtMaGV.setText("txtMaGV");

        txtHoTen.setText("txtHoTen");
        
        txtNgaySinh.setText("txtNgaySinh");

        txtNoiSinh.setText("txtNoiSinh");
        ...
        txtMonHoc.setText("txtMonHoc");

        txtGioiTinh.setText("txtGioiTinh");

        txtQueQuan.setText("txtQueQuan");
        ...
        txtNoiO.setText("txtNoiO");

        txtCCCD.setText("txtCCCD");

        txtSoDienThoai.setText("txtSoDienThoai");

        txtToChuyenMon.setText("txtToChuyenMon");
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {                                        
      ...
      // these are for edit form but i'm lazy to remove them
...
//        }
        if(isOK) {
            GiaoVienlist giaovien = new GiaoVienlist(
    ...
    public void setEditData(GiaoVienlist g) {
