...
public class LuongBienChe extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        String[] a = {"Mã giáo viên", "Loại giáo viên", "Lương căng bản", "Hệ số lương", "Hệ số tăng", "Năm kết nạp", "Bảo hiểm xã hội", "Mã thành tích", "Mã hình phạt"};
         int[] b = {90,90,90,90,90,90,110,90,90};
        ...
        jLabel1.setText("Danh sách lương biên chế ");
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                 "Mã giáo viên", "Loại giáo viên", "Lương căng bản", "Hệ số lương", "Hệ số tăng", "Năm kết nạp", "Bảo hiểm xã hội", "Mã thành tích", "Mã hình phạt"
            }
        ) {
