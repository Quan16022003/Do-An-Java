...
public class QuyDoiThanhTich extends javax.swing.JPanel {

    public QuyDoiThanhTich() {
        initComponents();
    ...
    private void initComponents() {
        ...
        String[] a = {"Mã thành tích", "Tên thành tích", "Học kỳ", "Năm học"};
         int[] b = {90,200,90,100};
        ...
        jLabel1.setText("Danh sách quy đổi thành tích");
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã thành tích", "Tên thành tích", "Học kỳ", "Năm học"
            }
        ) {
