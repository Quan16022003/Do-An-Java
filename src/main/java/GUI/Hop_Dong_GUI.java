 ...
 * @author apple
 */
public class Hop_Dong_GUI extends Content {
    
    private List<Hop_Dong> HopDongs;
    private HomeAbstractDataModel_for_Nhan_Vien tblModel;
    private int selectedIndex;
    private JTable table;
    private Hop_Dong_DAO Dao;
...
//        tblModel.setRowCount(0); // reset nd trong bang ve 0
    ...
    public void addNhanVienlist(Hop_Dong s) {
        HopDongs.add(s); //them moi sv vao danh sach
        showData();
    }
    
    public void removeNhanVienlist(Hop_Dong s) {
...
//            tablePanel.add(jScrollPane1);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Hop_Dong_GUI().setVisible(true);
            }
        });
    }
    ...
    public void updateNhanVienlist(Hop_Dong s) {
        HopDongs.remove(selectedIndex);
