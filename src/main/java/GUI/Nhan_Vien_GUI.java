...
public class Nhan_Vien_GUI extends Content {
    ...
    private List<Nhan_Vien> NhanViens;
...
//        tblModel.setRowCount(0); // reset nd trong bang ve 0
        tblModel.add(NhanViens);
    }
    
    public void addNhanVienlist(Nhan_Vien s) {
        NhanViens.add(s); //them moi sv vao danh sach
        showData();
    }
    
    public void removeNhanVienlist(Nhan_Vien s) {
...
//            tablePanel.add(jScrollPane1);
    ...
    public void updateNhanVienlist(Nhan_Vien s) {
        NhanViens.remove(selectedIndex);
