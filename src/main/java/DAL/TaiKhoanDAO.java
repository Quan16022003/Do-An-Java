...
public class TaiKhoanDAO extends AbstractDAO<TaiKhoan, String> {
    ...
    @Override
    protected List<TaiKhoan> convertResultSetToList(ResultSet rs) {
    ...
    public boolean insert(TaiKhoan taiKhoan) {
        ...
        int rowsInserted = mySQLConnection.executeUpdate(query, taiKhoan.getUsername(), taiKhoan.getPassword(), taiKhoan.getMaGiaoVien(), taiKhoan.getRole());
